module Hyrax
  class FileSetPresenter
    ...
    ################################################################
    def filetype
      solr_document._source["filetype_tesim"] ? solr_document._source["filetype_tesim"][0] : "Unknown"
    end
    ################################################################


    def external_file_url
      solr_document._source["external_file_url_tesim"] ? solr_document._source["external_file_url_tesim"][0] : "NA"
    end
